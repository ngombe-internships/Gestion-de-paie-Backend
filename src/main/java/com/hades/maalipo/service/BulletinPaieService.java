...
import com.hades.maalipo.repository.*;
...
public class BulletinPaieService {
    ...
    public BulletinPaie calculBulletin(BulletinPaie fiche) {
        ...
        if (fiche.getAvancesSurSalaires() != null && fiche.getAvancesSurSalaires().compareTo(BigDecimal.ZERO) > 0) {
            ...
            ElementPaie avanceElement = elementPaieRepository.findByDesignation("Avance sur salaire").orElse(null);
            ligneAvance.setElementPaie(avanceElement);
            ligneAvance.setType(TypeElementPaie.RETENUE);
            ligneAvance.setMontantFinal(fiche.getAvancesSurSalaires());
            ligneAvance.setMontantCalcul(fiche.getAvancesSurSalaires());
            ligneAvance.setNombre(BigDecimal.ONE);
            ligneAvance.setDescriptionDetaillee("Avance sur salaire du mois");
            fiche.addLignePaie(ligneAvance);
        }
        ...
        fiche.setSalaireNetAPayer(fiche.getSalaireNetAvantImpot().subtract(fiche.getTotalImpots()
                                        .subtract(nvl(fiche.getAvancesSurSalaires()))));
    ...
    public BulletinPaie mapCreateDtoToEntity(BulletinPaieCreateDto dto) {
        ...
        fiche.setAvancesSurSalaires(dto.getAvancesSurSalaires());
